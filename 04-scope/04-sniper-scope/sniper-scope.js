...
function jaws(agent) { // local var agent undefined
  agent = bond; // global var agent set to the global var bond
  bond = 'Body Double'; // global var bond changed to Body Double
...
function elChiffre() {
  // global var bond changed to Body Double by test of function jaws
  // so at the start of this function global var bond = Body Double
  let agent = bond; // local var agent set to the global var bond
  bond = 'Body Double'; 
